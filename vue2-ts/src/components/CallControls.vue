...
export default class CallControls extends Vue {
  isOnHold = false;
  isMuted = false;
  callStatus: "incoming" | "active" | "ended" = "incoming";

  handleAnswer(): void {
    this.callStatus = "active";
    console.log("📞 Answered call - Vue 2");
    // Thêm logic tích hợp với @mptransformation/omisdk tại đây
  }

  handleReject(): void {
    this.callStatus = "ended";
    console.log("❌ Rejected call - Vue 2");
    // Thêm logic tích hợp với @mptransformation/omisdk tại đây
  }
  ...
  handleHold(): void {
    ...
    if (this.isOnHold) {
      console.log("⏸️ Call on hold - Vue 2");
      // Thêm logic tích hợp với @mptransformation/omisdk tại đây
    } else {
      console.log("▶️ Call resumed - Vue 2");
      // Thêm logic tích hợp với @mptransformation/omisdk tại đây
    }
  }
  ...
  handleMute(): void {
    ...
    if (this.isMuted) {
      console.log("🔇 Microphone muted - Vue 2");
      // Thêm logic tích hợp với @mptransformation/omisdk tại đây
    } else {
      console.log("🔊 Microphone unmuted - Vue 2");
      // Thêm logic tích hợp với @mptransformation/omisdk tại đây
    }
  }
