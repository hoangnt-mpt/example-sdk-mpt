...
const CallControls = ({
  ...
  const makeCall = () => {
    ...
    console.log("📱 Making outbound call to:", phoneNumber, "- React Vite");

    // Simulate call connection after 2 seconds
    setTimeout(() => {
      setIsDialing(false);
      setCallStatus("active");
      console.log("✅ Call connected - React Vite");
    }, 2000);
  };
  ...
  const handleAnswer = () => {
    setCallStatus("active");
    onAnswer?.();
    console.log("📞 Answered call - React Vite");
  };

  const handleReject = () => {
    setCallStatus("ended");
    onReject?.();
    console.log("❌ Rejected call - React Vite");
  };
  ...
  const handleEnd = () => {
    ...
    setIsDialing(false);
    onEnd?.();
    console.log("📵 Ended call - React Vite");
  };
  ...
  const handleHold = () => {
    ...
    if (newHoldState) {
      onHold?.();
      console.log("⏸️ Call on hold - React Vite");
    } else {
      onUnHold?.();
      console.log("▶️ Call resumed - React Vite");
    }
  };
  ...
  const handleMute = () => {
    ...
    if (newMuteState) {
      onMute?.();
      console.log("🔇 Microphone muted - React Vite");
    } else {
      onUnMute?.();
      console.log("🔊 Microphone unmuted - React Vite");
    }
  };
  ...
  const resetCall = () => {
    ...
    setIsDialing(false);
    setPhoneNumber("");
    console.log("🔄 Call reset - React Vite");
  };
